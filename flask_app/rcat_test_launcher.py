...
#rcat().main_PDF(text_file="/Users/Florian/Applications/SourceTree/web-rcat/flask_app/data/CRETA_internal/Iwein/oneword/1_iwein_text.txt", character_file="/Users/Florian/Applications/SourceTree/web-rcat/flask_app/data/CRETA_internal/Iwein/oneword/2_iwein_characters.txt",
				dist_parameter=[10, 20, 20],
