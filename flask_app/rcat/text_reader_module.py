...
class text_reader:
    ...
    def tokenize_lemmatize_text(self, txt, lemmatize="n", text_language= "German"):#,remove_stopwords == "n"):
        ...
        if lemmatize == "n" and text_language=="MHG":
            ...
            #output = os.popen("../../treetagger/cmd/tree-tagger-middle-high-german > output.txt")
            #subprocess.check_output(["echo 'Dannen schiet sus Parzivâl', "|", "../../treetagger/cmd/tree-tagger-middle-high-german", ">", "output.txt"]
            os.popen("echo 'Dannen schiet sus Parzivâl' | ../../treetagger/cmd/tree-tagger-middle-high-german > output.txt") #output.read()
            #output.close()
